  ...
  return (
    ...
    >
      ...
      {"google" in enabledProviders && (
        <SocialProviderSection provider="google" animationDelay={0.4} />
      )}

      {"github" in enabledProviders && (
        <SocialProviderSection provider="github" animationDelay={0.5} />
      )}

      {"linkedin" in enabledProviders && (
        <SocialProviderSection provider="linkedin" animationDelay={0.6} />
      )}
