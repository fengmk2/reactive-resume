        ...
        <div className="text-muted-foreground">
          <Trans>
            ...
            <Button
              ...
              render={
                <Link to="/auth/login">
                  <Trans comment="Call-to-action link from registration page to login page">
                    Sign in now
                  </Trans>{" "}
                  <ArrowRightIcon />
                </Link>
  ...
  return (
    <>
      ...
      <Button
        ...
        render={
          <Link to="/dashboard">
            <Trans comment="Button label to continue to dashboard after successful registration">
              Continue
            </Trans>{" "}
            <ArrowRightIcon />
          </Link>
