...
const atlasCloudUrl =
  "https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=reactive-resume";
    ...
    <section className="px-8 py-20">
      <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
        ...
        <p className="mt-5 max-w-2xl text-base text-muted-foreground leading-relaxed">
          <Trans>
            Reactive Resume stays free, open-source, and independent because companies choose to
            support the work behind it. Their sponsorship helps fund hosting, maintenance, and
            continued development for the community.
          </Trans>
        </p>
        ...
        <p className="mt-8 max-w-2xl text-muted-foreground leading-relaxed">
          <Trans>
            Atlas Cloud supports Reactive Resume as a project sponsor. If your company would like to
            sponsor the project, email{" "}
            <a
