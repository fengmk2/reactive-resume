...
const createMarqueeItems = (
  entries: Array<[string, TemplateMetadata]>,
  rowId: string,
): TemplateMarqueeItem[] =>
    ...
    <section id="templates" className="overflow-hidden border-t-0! p-4 md:p-8 xl:py-16">
      ...
      >
        ...
        <p className="max-w-2xl text-muted-foreground leading-relaxed">
          <Trans>
            Explore our diverse selection of templates, each designed to fit different styles,
            professions, and personalities. Reactive Resume currently offers 12 templates, with more
            on the way.
          </Trans>
        </p>
      </m.div>
