...
import {
  ...
  AccordionContent,
  AccordionItem,
} from "@reactive-resume/ui/components/accordion";
        ...
        <AccordionItem value="isPrivate">
          <AccordionContent className="pb-0">
            <Alert>
              ...
              <AlertDescription>
                <Trans>
                  Turn on public sharing to track how many times your resume has been viewed or
                  downloaded. Only you can see your resume's statistics.
                </Trans>
              </AlertDescription>
            </Alert>
          </AccordionContent>
        ...
        <AccordionItem value="isPublic">
          <AccordionContent className="grid @md:grid-cols-2 grid-cols-1 gap-4 pb-0">
            <StatisticsItem
              ...
              timestamp={
                statistics.lastViewedAt
                  ? t`Last viewed on ${statistics.lastViewedAt.toDateString()}`
                  : null
              }
            />
            ...
            <StatisticsItem
              ...
              timestamp={
                statistics.lastDownloadedAt
                  ? t`Last downloaded on ${statistics.lastDownloadedAt.toDateString()}`
                  : null
              }
            />
          </AccordionContent>
