    ...
    <SectionBase type="export" className="space-y-4">
      ...
      >
        ...
        <div className="flex flex-1 flex-col gap-y-1">
          ...
          <p className="text-muted-foreground text-xs leading-normal">
            <Trans>
              Download a copy of your resume in JSON format. Use this file for backup or to import
              your resume into other applications, including AI assistants.
            </Trans>
          </p>
        </div>
      </Button>
      ...
      >
        ...
        <div className="flex flex-1 flex-col gap-y-1">
          ...
          <p className="text-muted-foreground text-xs leading-normal">
            <Trans>
              Download a copy of your resume as a Word document. Use this file to further customize
              your resume in Microsoft Word or Google Docs.
            </Trans>
          </p>
        </div>
      </Button>
      ...
      >
        ...
        <div className="flex flex-1 flex-col gap-y-1">
          ...
          <p className="text-muted-foreground text-xs leading-normal">
            <Trans>
              Download a copy of your resume in PDF format. Use this file for printing or to easily
