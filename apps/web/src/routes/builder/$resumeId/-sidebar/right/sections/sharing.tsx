        ...
        <div className="space-y-4 rounded-md border p-4">
          <div className="grid gap-2">
            <Label htmlFor="sharing-url">
              <Trans comment="Form field label for the generated public resume link in sharing settings">
                URL
              </Trans>
            </Label>
          ...
          <p className="text-muted-foreground">
            {isPasswordProtected ? (
              <Trans>
                Your resume's public link is currently protected by a password. Share the password
                only with people you trust.
              </Trans>
            ) : (
              <Trans>
                Optionally, set a password so that only people with the password can view your
                resume through the link.
              </Trans>
            )}
          </p>
