  ...
  return (
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          <Trans>
            This will generate a new API key to access the Reactive Resume API to allow machines to
            interact with your resume data.
          </Trans>
        </DialogDescription>
      </DialogHeader>
        ...
        <form.Field name="name">
          {(field) => (
            <FormItem hasError={field.state.meta.isTouched && field.state.meta.errors.length > 0}>
              ...
              <FormDescription>
                <Trans>
                  Tip: Give your API key a name, corresponding to the purpose of the key, to help
