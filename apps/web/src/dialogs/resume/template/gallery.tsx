...
import {
  ...
  HoverCardContent,
  HoverCardTrigger,
} from "@reactive-resume/ui/components/hover-card";
    ...
    <DialogContent className="lg:max-w-5xl">
      <DialogHeader className="gap-2">
        ...
        <DialogDescription className="leading-relaxed">
          <Trans>
            Here's a range of resume templates for different professions and personalities. Whether
            you prefer modern or classic, bold or simple, there is a design to match you. Look
            through the options below and choose a template that fits your style.
          </Trans>
        </DialogDescription>
      </DialogHeader>
