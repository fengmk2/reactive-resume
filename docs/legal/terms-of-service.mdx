...
<Note>
  Replace the placeholders above with the correct operator details for your deployment. If you are
  using the official hosted service at <code>rxresu.me</code>, the project's published support
  contact is <code>hello@amruthpillai.com</code>.
</Note>
