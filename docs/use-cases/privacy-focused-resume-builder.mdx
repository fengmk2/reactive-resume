...
<Info>
  Review the privacy policy for the instance you use. If you self-host, you are responsible for the
  deployment's data handling, storage, email, and third-party provider configuration.
</Info>
