...
<Tip>You can add or change tags when creating, updating, or duplicating a resume.</Tip>
...
<Step title="Choose Update">Select **Update** to open the resume details dialog.</Step>

<Step title="Edit the fields">Change the **Name**, **Slug**, or **Tags**.</Step>
...
<Warning>
  The slug is part of the public URL. If a resume is public, changing the slug changes the link
  people use to view it.
</Warning>
...
<Warning>
  Deleting a resume cannot be undone. If you might need the content later, export a JSON backup
  first. See [Exporting your resume](/guides/exporting-your-resume).
</Warning>
