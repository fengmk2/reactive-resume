...
<Step title="Hover over 'Move to'">
  In the dropdown menu, hover over or click the <Badge>Move to</Badge> option. This will open a
  submenu showing all available destinations.
</Step>
...
<Tip>
  **Keep it logical**: Maintain chronological order within each page. Move complete job entries
  rather than splitting a single role across pages.
</Tip>

<Tip>
  **Use custom section names**: After moving items to a new custom section, you can rename it (e.g.,
  "Earlier Experience" or "Additional Projects") to provide context for recruiters.
</Tip>

<Warning>
  Moving items reorganizes your content but doesn't affect the data itself. You can always move
  items back or to different sections as needed.
</Warning>
