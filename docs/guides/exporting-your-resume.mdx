...
<Step title="Choose a format">Click **JSON**, **DOCX**, or **PDF**.</Step>
...
<Info>
  The PDF is generated from your current resume data, template, typography, design, layout, and page
  settings.
</Info>
...
<Warning>
  DOCX exports are useful for editing, but the visual layout may not match the PDF exactly. Use PDF
  when exact visual fidelity matters.
</Warning>
...
<Warning>
  Review AI-generated changes before importing or using them. AI assistants can make mistakes or add
  details that do not reflect your experience.
</Warning>
