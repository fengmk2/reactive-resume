...
<Info>
  Private Notes are stored with that resume's data and are only visible to you when editing the
  resume.
</Info>
...
<Tip>
  Job postings often get taken down after a position is filled. Consider copying key requirements or
  responsibilities into your notes as a backup.
</Tip>
...
<Step title="Write your notes">
  Use the rich text editor to add your notes. You can format text with bold, italics, bullet points,
  and more.
</Step>
...
<Warning>
  Private Notes are for your eyes only. They will **never** appear in your exported files, on your
  public resume link, or in a printed version of your resume.
</Warning>
