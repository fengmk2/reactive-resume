...
<Step title="Choose the import type">Pick the format that matches your file.</Step>
...
<Warning>
  Always review an imported resume before sharing or exporting it. This is especially important for
  PDF and Word imports.
</Warning>
