...
export const websiteSchema = z.object({
  url: z
    .string()
    .describe(
      "The URL to show as a link. Must be a valid URL with a protocol (http:// or https://).",
    ),
  label: z
    .string()
    .describe("The label to display for the URL. Leave blank to display the URL as-is."),
});
...
export const pictureSchema = z.object({
  ...
  borderColor: z
    .string()
    .describe(
      "The color of the border of the picture to display on the resume, defined as rgba(r, g, b, a).",
    ),
  borderWidth: z
    .number()
    .min(0)
    .describe(
      "The width of the border of the picture to display on the resume, defined in points (pt).",
    ),
  shadowColor: z
    .string()
    .describe(
      "The color of the shadow of the picture to display on the resume, defined as rgba(r, g, b, a).",
    ),
  shadowWidth: z
    .number()
    .min(0)
    .describe(
      "The width of the shadow of the picture to display on the resume, defined in points (pt).",
    ),
});
...
export const summarySchema = z.object({
  ...
  columns: z
    ...
    .max(6)
    .catch(1)
    .describe("The number of columns the summary should span across."),
...
export const awardItemSchema = baseItemSchema.extend({
  ...
  description: z
    .string()
    .describe("The description of the award. This should be a HTML-formatted string."),
});
...
export const roleItemSchema = z.object({
  ...
  description: z
    .string()
    .describe("The description of this specific role. This should be a HTML-formatted string."),
});
...
export const interestItemSchema = baseItemSchema.extend({
  ...
  keywords: z
    ...
    .catch([])
    .describe(
      "The keywords associated with the interest/hobby, if any. These are displayed as tags below the name.",
    ),
});
...
export const profileItemSchema = baseItemSchema.extend({
  ...
  website: itemWebsiteSchema.describe(
    "The link to the profile of the author on the network or platform, if any.",
  ),
});
...
export const projectItemSchema = baseItemSchema.extend({
  ...
  description: z
    .string()
    .describe("The description of the project. This should be a HTML-formatted string."),
});
...
export const skillItemSchema = baseItemSchema.extend({
  ...
  keywords: z
    ...
    .catch([])
    .describe(
      "The keywords associated with the skill, if any. These are displayed as tags below the name.",
    ),
});
...
export const volunteerItemSchema = baseItemSchema.extend({
  ...
  description: z
    .string()
    .describe(
      "The description of the volunteer experience. This should be a HTML-formatted string.",
    ),
});
...
export const coverLetterItemSchema = baseItemSchema.extend({
  ...
  content: z
    .string()
    .describe("The cover letter body as HTML (salutation, paragraphs, closing, signature)."),
});
...
export const baseSectionSchema = z.object({
  ...
  columns: z
    ...
    .max(6)
    .catch(1)
    .describe("The number of columns the section should span across."),
...
export const certificationsSectionSchema = baseSectionSchema.extend({
  items: z
    ...
    .describe("The items to display in the certifications section."),
});
...
export const publicationsSectionSchema = baseSectionSchema.extend({
  items: z
    ...
    .describe("The items to display in the publications section."),
});
...
export const sectionsSchema = z.object({
  ...
  experience: experienceSectionSchema.describe(
    "The section to display the experience of the author.",
  ),
  ...
  certifications: certificationsSectionSchema.describe(
    "The section to display the certifications of the author.",
  ),
  publications: publicationsSectionSchema.describe(
    "The section to display the publications of the author.",
  ),
  volunteer: volunteerSectionSchema.describe(
    "The section to display the volunteer experience of the author.",
  ),
  references: referencesSectionSchema.describe(
    "The section to display the references of the author.",
  ),
});
...
export const customSectionSchema = baseSectionSchema.extend({
  ...
  items: z
    ...
    .describe(
      "The items to display in the custom section. Items follow the schema of the section type.",
    ),
});
...
export const typographyItemSchema = z.object({
  fontFamily: z
    .string()
    .describe("The family of the font to use. Must be a supported resume font."),
  fontWeights: z
  ...
  fontSize: z
    ...
    .max(24)
    .catch(11)
    .describe("The size of the font to use, defined in points (pt)."),
  lineHeight: z
    .number()
    .min(0.5)
    .max(4)
    .catch(1.5)
    .describe(
      "The line height of the font to use, defined as a multiplier of the font size (e.g. 1.5 for 1.5x).",
    ),
});
...
export const pageSchema = z.object({
  gapX: z
    .number()
    .min(0)
    .describe("The horizontal gap between the sections of the page, defined in points (pt)."),
  gapY: z
    .number()
    .min(0)
    .describe("The vertical gap between the sections of the page, defined in points (pt)."),
  ...
  locale: z
    .string()
    .describe(
      "The locale of the page. Used for displaying pre-translated section headings, if not overridden.",
    )
    .catch("en-US"),
  hideLinkUnderline: z
    .boolean()
    .describe("Whether to hide the underlines of the links.")
    .catch(false),
  hideIcons: z
    .boolean()
    .describe("Whether to hide the item-level icons (skills, profiles, interests).")
    .catch(false),
  hideSectionIcons: z
    .boolean()
...
export const colorDesignSchema = z.object({
  ...
  text: z
    .string()
    .describe(
      "The text color of the design, defined as rgba(r, g, b, a). Usually set to black: rgba(0, 0, 0, 1).",
    ),
  background: z
    .string()
    .describe(
...
export const metadataSchema = z.object({
  template: templateSchema
    .catch("onyx")
    .describe(
      "The template to use for the resume. Determines the overall design and appearance of the resume.",
    ),
...
export const resumeDataSchema = z.looseObject({
  ...
  summary: summarySchema.describe(
    "Summary section of the resume, useful for a short bio or introduction",
  ),
