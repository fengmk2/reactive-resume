...
describe("normalizeRichTextHtml", () => {
  ...
  it("preserves existing block rich text", () => {
    expect(
      normalizeRichTextHtml("<p>Existing paragraph.</p><ul><li><p>Existing item.</p></li></ul>"),
    ).toBe("<p>Existing paragraph.</p><ul><li>Existing item.</li></ul>");
  });

  it("wraps inline runs around top-level blocks", () => {
    expect(
      normalizeRichTextHtml("Intro <strong>text</strong><ul><li><p>Item</p></li></ul>Outro"),
    ).toBe("<p>Intro <strong>text</strong></p><ul><li>Item</li></ul><p>Outro</p>");
  });
});
