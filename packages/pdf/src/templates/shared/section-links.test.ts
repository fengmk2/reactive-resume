...
describe("getInlineItemWebsiteUrl", () => {
  it("returns the url when url is set and inlineLink is true", () => {
    expect(
      getInlineItemWebsiteUrl({ url: "https://example.com", label: "", inlineLink: true }),
    ).toBe("https://example.com");
  });

  it("returns undefined when inlineLink is false", () => {
    expect(
      getInlineItemWebsiteUrl({ url: "https://example.com", label: "", inlineLink: false }),
    ).toBeUndefined();
  });
...
describe("shouldRenderSeparateItemWebsite", () => {
  it("returns true when url is set and inlineLink is false", () => {
    expect(
      shouldRenderSeparateItemWebsite({ url: "https://example.com", label: "", inlineLink: false }),
    ).toBe(true);
  });
  ...
  it("returns false when inlineLink is true", () => {
    expect(
      shouldRenderSeparateItemWebsite({ url: "https://example.com", label: "", inlineLink: true }),
    ).toBe(false);
  });
