...
export const Text = ({ style, ...props }: ComponentProps<typeof PdfText>) => {
  ...
  return (
    <PdfText
      style={composeStyles(textStyle, textRuleStyle, asStyleInput(style), safeTextStyle)}
      {...props}
    />
  );
};
...
export const Heading = ({ style, ...props }: ComponentProps<typeof PdfText>) => {
  ...
  return (
    <PdfText
      style={composeStyles(headingStyle, headingRuleStyle, asStyleInput(style), safeTextStyle)}
      {...props}
    />
  );
};
...
export const SectionHeadingIcon = ({
  ...
  const { style: sectionIconStyle, ...sectionIconProps } =
    useTemplateIconSlot("sectionHeadingIcon");
  ...
  const templateIconSize =
    hasSlot && (typeof templateSize === "number" || typeof templateSize === "string")
      ? templateSize
      : undefined;
